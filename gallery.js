const galleryItems = [
  ...
  },
  {
    ...
    alt: "Indigo Cover",
    description: "Cover of my single Indigo (released in June 2024). The song is definitely one of my personal favorits. It was also the first time ever I used AI to generate (parts of) the cover image. Shortly after, I decided to not continue using AI images furthermore. Using my own photos instead for covers is definitely more work, but I hope they give my releases a more personal, also more human touch."
  },
  {
    title: "Artist Logo",
    thumb: "gallery/This_is_denada_Cover.png",
    image: "gallery/This_is_denada_Cover.png",
    alt: "My denada artist logo",
  ...
  },
  {
    ...
    alt: "Breathe Cover",
    description: "A bench at the west coast of Sweden. I took this picture during my summer holidays in 2021. It became the cover image of my song Breathe. The song really is something different from my usual style. I thought about taking it down several times, because it might be too different, but I still like it too much for that."
  },
  {
    title: "Happy Focusing!",
    thumb: "gallery/Happy_focusing.jpg",
    image: "gallery/Happy_focusing.jpg",
    alt: "Happy Focusing playlist cover",
    description: "Cover art of one of my main playlists: Happy Focusing! This is my oldest but also one of my most impactful playlists, reaching more than 600 monthly listeners. My girlfriend took this picture when we travelled to Bali, Indonesia, in 2018."
  }  
];
